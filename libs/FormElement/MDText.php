...
class MDText extends Typecho\Widget\Helper\Form\Element
{
    ...
    {
        if ($isOpen) {
            $wrapper = '<div class="mdui-panel notice-md3-field-panels"><div class="mdui-panel-item notice-md3-field notice-md3-field--text mdui-panel-item-open"><div class="mdui-panel-item-header notice-md3-field__header" role="button" tabindex="0" onclick="this.parentNode.classList.toggle(\'mdui-panel-item-open\');">' . $label . '</div><div class="mdui-panel-item-body notice-md3-field__body"><ul class="notice-md3-option-list" style="padding-left: 0; list-style: none !important" id="typecho-option-item-' . $name . '-' . self::$uniqueId . '">';
        } else {
            $wrapper = '<div class="mdui-panel notice-md3-field-panels"><div class="mdui-panel-item notice-md3-field notice-md3-field--text"><div class="mdui-panel-item-header notice-md3-field__header" role="button" tabindex="0" onclick="this.parentNode.classList.toggle(\'mdui-panel-item-open\');">' . $label . '</div><div class="mdui-panel-item-body notice-md3-field__body"><ul class="notice-md3-option-list" style="padding-left: 0; list-style: none !important" id="typecho-option-item-' . $name . '-' . self::$uniqueId . '">';
        }
    ...
    public function input(?string $name = null, ?array $options = null): ?Typecho\Widget\Helper\Layout
    {
        ...
        $input = new Typecho\Widget\Helper\Layout('input', array(
